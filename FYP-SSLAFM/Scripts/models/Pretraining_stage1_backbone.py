...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim=512):
        ...
        # Convert 1D vector back to feature map
        self.fc_input = nn.Linear(latent_dim, 256 * 16 * 16)
        ...
        # combine 6 channels back to 3 channels (RGB)
...
if __name__ == "__main__":
    onset_frame = torch.randn(8, 3, 128, 128)
    offset_frame = torch.randn(8, 3, 128, 128)
